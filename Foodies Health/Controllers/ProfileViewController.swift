...
class ProfileViewController: UIViewController, UITableViewDelegate { //UITableViewDataSource {
    ...
    private func setUpTableHeader(
        ...
        let headerView = UIView(frame: CGRect(x: 0, y: 0, width: view.width, height: view.width/1.25))
   ...
   @objc private func didTapSignOut() {
       let sheet = UIAlertController(title: "Sign Out", message: "Are sure you'd like to out",
